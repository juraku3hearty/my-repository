...
const FAMILY = [
  { label: '本人', name: '平井真弓', solar: '1983-1-8',   time: 2, gender: '女', note: '4:13 滋賀' },
  { label: '旦那', name: '平井伸幸', solar: '1983-3-14',  time: 4, gender: '男', note: '8:45 京都' },
  { label: '長女', name: '平井麗波', solar: '2008-8-1',   time: 8, gender: '女', note: '15:51 京都' },
  { label: '次女', name: '平井絢葉', solar: '2011-12-12', time: 8, gender: '女', note: '16:24 京都' },
  { label: '三女', name: '平井琴芭', solar: '2013-7-28',  time: 9, gender: '女', note: '17:43 京都' },
];
...
FAMILY.forEach((m) => {
  ...
  const html = render(astro, { name: m.name });
  const out = path.join(outDir, `帝の書_${m.label}_${m.name}.html`);
