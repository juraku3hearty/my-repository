...
const SAMPLE = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        '先のことまで頭が回るぶん、まだ起こってもないことまで心配して、動く前に立ち止まってしまうことがあるかもしれません。でも、本当に「こんな状態で動いていいのかな」と思うくらいの段階で一歩出てみたほうが、案外そこから進み始めます。',
  ...
  footnotes: [
    ...
    '※ 解釈は本サービスの「基準書」のみを根拠にしています。主星と四化を中心に読み、基準書に項目のない細かな星（命宮の陀羅・華蓋など）は今回は扱っていません。',
    '※ 命宮・夫妻宮が空宮のため、紫微斗数の定石にしたがい向かいの宮の主星を借りて読みました。命盤計算：iztro。',
    '※ 本鑑定は自己理解を目的としたもので、医療・法律・投資などの専門的助言ではありません。大切な判断はご自身の責任で行ってください。',
  ],
};
